...
The code MUST be generated by the implementation itself using a CSPRNG,
and presented to the user for safekeeping. Its format SHOULD be 24 
uppercase alphanumeric characters, divided into six blocks of four,
separated by dashes. This format holds 124 bits of data, it is designed
to be unambiguous, pronounceable, and split into blocks that can be 
